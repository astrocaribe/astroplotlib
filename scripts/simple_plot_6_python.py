...
# Header
"""
:Description:   Data read from a file.
                Plots single data points using different symbols and colors and
                labels data points.
...
# Name output file
psName = '../plots/simple_plot_6.pdf'
...
mag36, mag45, classif = np.loadtxt('../data/data.mag', usecols = (0, 1, 2), unpack = True)
